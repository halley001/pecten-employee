        ...
        var a = i.is_mobile()
          ...
          , u = function(n, o) {
            ...
            "auto" != o.sliderLayout && 0 == n.closest(".forcefullwidth_wrapper_tp_banner").length && ("fullscreen" !== o.sliderLayout || "on" != o.fullScreenAutoWidth)) {
                ...
                b = b === t ? 0 : b,
                w = w === t ? 0 : w,
                m.wrap('<div class="forcefullwidth_wrapper_tp_banner" style="position:relative;width:100%;height:auto;margin-top:' + w + ";margin-bottom:" + b + '"></div>'),
            ...
            !n.hasClass("revslider-initialised")) {
                ...
                n.find(".tp-caption, .rs-background-video-layer").each(function(n) {
                    ...
                    a && ((1 == s || "true" == s) && (r.data("autoplayonlyfirsttime", "false"),
                    s = !1),
                    (1 == l || "true" == l || "on" == l || "1sttime" == l) && (r.data("autoplay", "off"),
                    l = "off")),
          ...
          , y = function(n, o) {
            ...
            o.li.find(">img").each(function(i) {
                ...
                "on" == o.panZoomDisableOnMobile && a && (n.data("kenburns", "off"),
                n.data("bgfit", "cover")),
          ...
          , _ = function(t, i, a) {
            ...
            i.loadqueue && e.each(i.loadqueue, function(e, i) {
                ...
                r += n,
                (w(r) === w(decodeURIComponent(t.src)) || w(o) === w(decodeURIComponent(t.src)) || w(d) === w(decodeURIComponent(t.src)) || w(l) === w(decodeURIComponent(t.src)) || w(s) === w(decodeURIComponent(t.src)) || w(i.src) === w(decodeURIComponent(t.src)) || w(i.src).replace(/^.*\/\/[^\/]+/, "") === w(decodeURIComponent(t.src)).replace(/^.*\/\/[^\/]+/, "") || "file://" === window.location.origin && w(t.src).match(new RegExp(n))) && (i.progress = a,
                i.width = t.width,
                i.height = t.height)
            }),
            k(i)
          ...
          , A = function(t, a) {
            ...
            t.trigger("stoptimer"),
            a.cd = 0,
            "off" === a.spinner ? t.find(".tp-loader").css({
                display: "none"
...
/*
     FILE ARCHIVED ON 21:25:25 Feb 07, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:34:04 Nov 12, 2023.
...
/*
playback timings (ms):
  captures_list: 138.673
  exclusion.robots: 0.069
  exclusion.robots.policy: 0.059
  cdx.remote: 0.057
  esindex: 0.01
  LoadShardBlock: 107.38 (3)
  PetaboxLoader3.datanode: 134.463 (5)
  load_resource: 144.898 (2)
  PetaboxLoader3.resolve: 60.603 (2)
*/

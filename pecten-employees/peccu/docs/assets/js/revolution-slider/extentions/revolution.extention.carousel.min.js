...
*********************************************/
    !function() {
        ...
        jQuery.extend(!0, e, {
            ...
            organiseCarousel: function(e, i, t, a) {
                ...
                s.slides && jQuery.each(s.slides, function(a, r) {
                    var n = l[a];
                    "on" === s.infinity && (n = n > s.wrapwidth - s.inneroffset && "left" === i ? l[0] - (o - a) * s.slide_width : n,
                    n = n < 0 - s.inneroffset - s.slide_width ? "left" == i ? n + s.maxwidth : "right" === i ? l[o - 1] + (a + 1) * s.slide_width : n : n);
                    var d = new Object;
                    ...
                    if ((t && Math.abs(h) < f || 0 === h) && (f = Math.abs(h),
                    s.focused = a),
                    ...
                    "on" === s.fadeout)
                        ...
                        d.autoAlpha = Math.abs(h) < Math.ceil(s.maxVisibleItems / w) ? 1 : 0;
                    ...
                    d.autoAlpha = Math.abs(d.rotationY) > 90 ? 0 : d.autoAlpha) : d.rotationY = h >= 1 || -1 >= h ? s.maxRotation : Math.abs(h) * s.maxRotation,
                    ...
                    d.transformStyle = "3D" != e.parallax.type && "3d" != e.parallax.type ? "flat" : "preserve-3d",
                    punchgs.TweenLite.set(r, d)
                }),
                a && (e.c.find(".next-revslide").removeClass("next-revslide"),
        ...
        var i = function(e) {
            ...
            0 !== i.maxRotation && ("3D" != e.parallax.type && "3d" != e.parallax.type ? punchgs.TweenLite.set(i.wrap, {
                perspective: 1200,
                transformStyle: "flat"
          ...
          , t = function(t) {
            ...
            "right" === a.horizontal_align ? punchgs.TweenLite.set(a.wrap, {
                left: "auto",
          ...
          , s = function(i, t, s) {
            ...
            l.positionanim = punchgs.TweenLite.to(o, 1.2, {
                ...
                onComplete: function() {
                    l.slide_globaloffset = "off" === l.infinity ? l.slide_globaloffset + l.slide_offset_target : e.simp(l.slide_globaloffset + l.slide_offset_target, l.maxwidth),
                    l.slide_offset = e.simp(l.slide_offset, l.maxwidth),
...
/*
     FILE ARCHIVED ON 13:49:57 Feb 03, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:35:06 Nov 12, 2023.
...
/*
playback timings (ms):
  captures_list: 143.571
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.059
  cdx.remote: 0.057
  esindex: 0.009
  LoadShardBlock: 58.132 (3)
  PetaboxLoader3.datanode: 98.54 (5)
  load_resource: 258.102 (2)
  PetaboxLoader3.resolve: 175.048 (2)
*/

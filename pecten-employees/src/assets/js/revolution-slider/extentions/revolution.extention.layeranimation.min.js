    ...
    !function(a) {
        ...
        jQuery.extend(!0, t, {
            animcompleted: function(a, e) {
                ...
                void 0 != i && "none" != i && (1 == n || "true" == n || "on" == n || "1sttime" == n || o ? (t.playVideo(a, e),
                t.toggleState(a.data("videotoggledby")),
                (o || "1sttime" == n) && (a.data("autoplayonlyfirsttime", !1),
                a.data("autoplay", "off"))) : ("no1sttime" == n && a.data("autoplay", "on"),
            ...
            animateTheCaptions: function(a, e, i, n) {
                ...
                e.debugMode) {
                    ...
                    l.append('<div class="hginfo">Zoom:' + Math.round(100 * e.bw) + "% &nbsp;&nbsp;&nbsp; Device Level:" + e.curWinRange + "&nbsp;&nbsp;&nbsp; Grid Preset:" + e.gridwidth[e.curWinRange] + "x" + e.gridheight[e.curWinRange] + "</div>"),
            ...
            animateSingleCaption: function(a, n, r, u, w, y, b) {
                ...
                if (a.data("_pw") || (a.data("_pw", L),
                a.data("_lw", W),
                a.data("_mw", C)),
                "fullscreen" == n.sliderLayout && (u = _ / 2 - n.gridheight[n.curWinRange] * n.bh / 2),
                ("on" == n.autoHeight || void 0 != n.minHeight && n.minHeight > 0) && (u = n.conh / 2 - n.gridheight[n.curWinRange] * n.bh / 2),
                0 > u && (u = 0),
                n.debugMode) {
                ...
                if ("off" == Q || k < n.hideCaptionAtLimit && "on" == a.data("captionhidden") || k < n.hideAllCaptionAtLimit ? a.addClass("tp-hidden-caption") : a.removeClass("tp-hidden-caption"),
                ...
                a.find("img").length > 0) {
                    ...
                    void 0 == O && (O = 0),
                    void 0 == H && (H = 0),
                    "off" !== j ? ("grid" != R && F ? M.width(O) : M.width(O * n.bw),
                    "grid" != R && D ? M.height(H) : M.height(H * n.bh)) : (M.width(O),
                    M.height(H))
                }
                if ("slide" === R && (r = 0,
                u = 0),
                a.hasClass("tp-videolayer") || a.find("iframe").length > 0 || a.find("video").length > 0) {
                    if (a.data("layertype", "video"),
                    ...
                    void 0 == a.data("videowidth") && (a.data("videowidth", M.width()),
                    a.data("videoheight", M.height()));
                    var Z, O = p(a.data("videowidth"), n)[n.curWinRange] || p(a.data("videowidth"), n) || "auto", H = p(a.data("videoheight"), n)[n.curWinRange] || p(a.data("videoheight"), n) || "auto";
                    O = parseFloat(O),
                    H = parseFloat(H),
                    void 0 === a.data("cssobj") && (Z = g(a, 0),
                    a.data("cssobj", Z));
                    var $ = m(a.data("cssobj"), n);
                    if ("auto" == $.lineHeight && ($.lineHeight = $.fontSize + 4),
                    ...
                    (0 == V && !N || 1 != a.data("forcecover") && !a.hasClass("fullscreenvideo") && !N) && (M.width(O * n.bw),
                    M.height(H * n.bh))
                }
                ...
                "on" == n.fullScreenAlignForce && (ra = n.ulw,
                da = n.ulh),
                aa = "center" === aa || "middle" === aa ? ra / 2 - ta / 2 + oa : "left" === aa ? oa : "right" === aa ? ra - ta - oa : "off" !== I ? aa * n.bw : aa,
                ea = "center" == ea || "middle" == ea ? da / 2 - ia / 2 + na : "top" == ea ? na : "bottom" == ea ? da - ia - na : "off" !== I ? ea * n.bw : ea,
                S && (aa += ta);
                var sa = a.data("lasttriggerstate")
                  ...
                  , ma = ea + u
                  , ua = a.css("z-Index");
                b || ("reset" == sa && "bytrigger" != pa ? (a.data("triggerstate", "on"),
                a.data("animdirection", "in"),
                la = "on") : "reset" == sa && "bytrigger" == pa && (a.data("triggerstate", "off"),
                ...
                0 == T && (x = !0),
                void 0 == a.data("timeline") || x || (2 != T && a.data("timeline").gotoAndPlay(0),
                x = !0),
                !y && a.data("timeline_out") && 2 != T && 0 != T && (a.data("timeline_out").kill(),
                a.data("outstarted", 0)),
                b && void 0 != a.data("timeline") && (a.removeData("$anims"),
                a.data("timeline").pause(0),
                a.data("timeline").kill(),
                void 0 != a.data("newhoveranim") && (a.data("newhoveranim").progress(0),
                a.data("newhoveranim").kill()),
                ...
                if (fa = jQuery.isNumeric(fa) ? fa : 0,
                wa.pause(),
                1 > fa && 1 != a.data("outstarted") || 2 == T || b) {
                    var ya = a;
                    if (void 0 != a.data("mySplitText") && a.data("mySplitText").revert(),
                    ...
                    if (!a.data("$anims") || b || Ta) {
                        ...
                        ja && (Ca = s(Ca, a.data("transform_hover")),
                        ...
                        ja && !a.hasClass("rs-hover-ready") && (a.addClass("rs-hover-ready"),
                        a.hover(function(a) {
                            var e = jQuery(a.currentTarget)
                              , t = e.data("hover")
                              , i = e.data("timeline");
                            i && 1 == i.progress() && (void 0 === e.data("newhoveranim") || "none" === e.data("newhoveranim") ? e.data("newhoveranim", punchgs.TweenLite.to(e, t.speed, t.anim)) : (e.data("newhoveranim").progress(0),
                    ...
                    if (xa.f.anim.x = xa.f.anim.x * n.bw || d(xa.f.anim.x, n, ta, ia, ma, ga, "horizontal"),
                    ...
                    2 != T || b) {
                        ...
                        if (xa.f.anim.visibility = "hidden",
                        ...
                        "sliderenter" == pa && n.overcontainer && (ca = .6),
                        ...
                        Ia) {
                            ...
                            wa.add(punchgs.TweenLite.set(C, {
                                overflow: "visible"
                            }, La.elemdelay), 0)
                    }
                    a.data("timeline", wa),
                    ...
                    ("sliderenter" != pa || "sliderenter" == pa && n.overcontainer) && (-1 == T || 1 == T || b || 0 == T && 1 > fa && a.hasClass("rev-static-visbile")) && (1 > fa && fa > 0 || 0 == fa && "bytrigger" != pa && "keep" != sa || 0 == fa && "bytrigger" != pa && "keep" == sa && "on" == la || "bytrigger" == pa && "keep" == sa && "on" == la) && (wa.resume(va),
                    t.toggleState(a.data("layertoggledby")))
                }
            ...
            endMoveCaption: function(a, e, t, o) {
                ...
                var r = new punchgs.TimelineLite
                  ...
                  , f = a.innerHeight()
                  , w = t.position();
                a.data("transform_out") && a.data("transform_out").match(/auto:auto/g) && (c.speed = g.speed,
                c.anim.ease = g.anim.ease,
                g = c);
                ...
                r.add(h.to(e, g.speed, y.anim, u), 0)) : r.add(h.set(e, {
                    overflow: "visible",
                    overwrite: "auto"
                }, u), 0),
        ...
        var i = function() {
          ...
          , d = function(a, e, t, i, n, o, r) {
            ...
            "horizontal" == r ? a = (t + 2) * parseInt(a, 0) / 100 : "vertical" == r && (a = (i + 2) * parseInt(a, 0) / 100)) : (a = "layer_left" === a ? 0 - t : "layer_right" === a ? t : a,
          ...
          , s = function(a, e, t) {
            ...
            return n && jQuery.each(n, function(a, e) {
                var n = e.split(":")
                  , o = n[0]
                  , d = n[1];
                t && void 0 != d && d.length > 0 && d.match(/\(R\)/) && (d = d.replace("(R)", ""),
          ...
          , h = function(a, e, t, i) {
            ...
            if (a.hasClass("tp-static-layer")) {
                ...
                s = -1 == s ? 0 : s,
                "in" === t ? a.hasClass("rev-static-visbile") ? n = r == s || o > s || s > r ? 2 : 0 : s >= o && r >= s || o == s || r == s ? (i || (a.addClass("rev-static-visbile"),
                a.removeClass("rev-static-hidden")),
                n = 1) : n = 0 : a.hasClass("rev-static-visbile") ? o > s || s > r ? (n = 2,
                i || (a.removeClass("rev-static-visbile"),
                a.addClass("rev-static-hidden"))) : n = 0 : n = 2
            }
            return n
        }
          , c = function(a, e) {
          ...
          , g = function(a, e) {
            ...
            "rekursive" != e) {
                if (i.color = void 0 === a.data("color") ? "nopredefinedcolor" : a.data("color"),
            ...
            return i.styleProps = a.css(["background-color", "border-top-color", "border-bottom-color", "border-right-color", "border-left-color", "border-top-style", "border-bottom-style", "border-left-style", "border-right-style", "border-left-width", "border-right-width", "border-bottom-width", "border-top-width", "color", "text-decoration", "font-style", "border-radius"]),
            i
        }
          , m = function(a, e) {
            var t = new Object;
          ...
          , u = function(a, e, t, i) {
            return a = jQuery.isNumeric(a) ? a * e + "px" : a,
            a = "full" === a ? i : "auto" === a || "none" === a ? t : a
        }
          , v = function(a, e, t, i) {
            var n;
            void 0 === a.data("cssobj") ? (n = g(a, t),
            a.data("cssobj", n)) : n = a.data("cssobj");
            var o = m(n, e)
              , r = e.bw
              , d = e.bh;
            if ("off" === i && (r = 1,
            ...
            !a.hasClass("tp-splitted")) {
                ...
                if (s && punchgs.TweenLite.set(a, o.styleProps),
                punchgs.TweenLite.set(a, {
          ...
          , w = function(a) {
            a.find(".rs-pendulum, .rs-slideloop, .rs-pulse, .rs-wave").each(function() {
                var a = jQuery(this);
                void 0 != a.data("loop-timeline") && (a.data("loop-timeline").pause(),
                a.data("loop-timeline", null))
            })
        }
    }(jQuery);
...
/*
     FILE ARCHIVED ON 22:53:39 Feb 07, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:35:16 Nov 12, 2023.
...
playback timings (ms):
  ...
  cdx.remote: 0.055
  esindex: 0.009
  LoadShardBlock: 87.775 (3)
  PetaboxLoader3.datanode: 113.583 (5)
  load_resource: 948.132 (2)
  PetaboxLoader3.resolve: 775.271 (2)
*/
